                                ...
                                <div className="i relative text-center">
                                    ...
                                    {tarima==1&&(
                                        <div className='grid grid-cols-7 top-[10%] left-2 text-center h-[40%] absolute w-[70%] z-10 '>
                                            <button id='Esp1' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(81)} style={{backgroundColor:(val1=='81'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>1</span></button>
                                            <button id='Esp2' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(80)} style={{backgroundColor:(val1=='80'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>2</span></button>
                                            <button id='Esp3' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(79)} style={{backgroundColor:(val1=='79'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>3</span></button>
                                            <button id='Esp4' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(78)} style={{backgroundColor:(val1=='78'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>4</span></button>
                                            <button id='Esp5' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(77)} style={{backgroundColor:(val1=='77'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>5</span></button>
                                            <button id='Esp6' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(76)} style={{backgroundColor:(val1=='76'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>6</span></button>
                                            <button id='Esp7' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(75)} style={{backgroundColor:(val1=='75'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>7</span></button>

                                            <button id='Esp8' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(90)} style={{backgroundColor:(val1=='90'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>8</span></button>
                                            <button id='Esp9' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(89)} style={{backgroundColor:(val1=='89'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>9</span></button>
                                            <button id='Esp10' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(88)} style={{backgroundColor:(val1=='88'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>10</span></button>
                                            <button id='Esp11' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(87)} style={{backgroundColor:(val1=='87'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>11</span></button>
                                            <button id='Esp12' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(86)} style={{backgroundColor:(val1=='86'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>12</span></button>
                                            <button id='Esp13' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(85)} style={{backgroundColor:(val1=='85'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>13</span></button>
                                            <button id='Esp14' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(84)} style={{backgroundColor:(val1=='84'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>14</span></button>

                                            <button id='Esp15' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(99)} style={{backgroundColor:(val1=='99'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>15</span></button>
                                            <button id='Esp16' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(98)} style={{backgroundColor:(val1=='98'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>16</span></button>
                                            <button id='Esp17' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(97)} style={{backgroundColor:(val1=='97'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>17</span></button>
                                            <button id='Esp18' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(96)} style={{backgroundColor:(val1=='96'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>18</span></button>
                                            <button id='Esp19' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(95)} style={{backgroundColor:(val1=='95'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>19</span></button>
                                            <button id='Esp20' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(94)} style={{backgroundColor:(val1=='94'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>20</span></button>
                                            <button id='Esp21' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(93)} style={{backgroundColor:(val1=='93'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>21</span></button>

                                            <button id='Esp22' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(108)} style={{backgroundColor:(val1=='108'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>22</span></button>
                                            <button id='Esp23' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(107)} style={{backgroundColor:(val1=='107'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>23</span></button>
                                            <button id='Esp24' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(106)} style={{backgroundColor:(val1=='106'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>24</span></button>
                                            <button id='Esp25' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(105)} style={{backgroundColor:(val1=='105'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>25</span></button>
                                            <button id='Esp26' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(104)} style={{backgroundColor:(val1=='104'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>26</span></button>
                                            <button id='Esp27' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(103)} style={{backgroundColor:(val1=='103'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>27</span></button>
                                            <button id='Esp28' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(102)} style={{backgroundColor:(val1=='102'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>28</span></button>

                                            <button id='Esp29' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(117)} style={{backgroundColor:(val1=='117'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>29</span></button>
                                            <button id='Esp30' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(116)} style={{backgroundColor:(val1=='116'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>30</span></button>
                                            <button id='Esp31' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(115)} style={{backgroundColor:(val1=='115'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>31</span></button>
                                            <button id='Esp32' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(114)} style={{backgroundColor:(val1=='114'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>32</span></button>
                                            <button id='Esp33' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(113)} style={{backgroundColor:(val1=='113'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>33</span></button>
                                            <button id='Esp34' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(112)} style={{backgroundColor:(val1=='112'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>34</span></button>
                                            <button id='Esp35' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(111)} style={{backgroundColor:(val1=='111'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>35</span></button>

                                            <button id='Esp36' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(126)} style={{backgroundColor:(val1=='126'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>36</span></button>
                                            <button id='Esp37' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(125)} style={{backgroundColor:(val1=='125'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>37</span></button>
                                            <button id='Esp38' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(124)} style={{backgroundColor:(val1=='124'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>38</span></button>
                                            <button id='Esp39' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(123)} style={{backgroundColor:(val1=='123'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>39</span></button>
                                            <button id='Esp40' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(122)} style={{backgroundColor:(val1=='122'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>40</span></button>
                                            <button id='Esp41' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(121)} style={{backgroundColor:(val1=='121'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>41</span></button>
                                            <button id='Esp42' className='border-4 border-solid border-indigo-50' onClick={(e)=>setValues(120)} style={{backgroundColor:(val1=='120'?'#4F91BB':val2=='1'?'#923128':'')}}><span className='text-white text-sm sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl'>42</span></button>
                                        </div>
                                    )}
                                    {tarima==2&&(
